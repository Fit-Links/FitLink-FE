...
import { Popup, PopupButtonGroup, PopupContainer, PopupTitle } from "@5unwan/ui/components/PopUp";
...
export const Default: Story = {
  render: () => {
    return (
      <Popup className="relative h-[300px] w-full">
        <PopupContainer className="h-[180px] w-[292px]">
          <PopupTitle>
            예정되어 있는 PT 수업 시간을
            <br />
            삭제하시겠습니까?
